...
public class SaleProcessDetail_XSTHDController {
    private Main main;
    private UserVO userVO;
    private SaleReturnVO saleReturnVO;
    private ArrayList<SaleReturnVO> mainList;
    ...
    public SaleProcessDetail_XSTHDController(){

    }//一个构造函数

    public void setMain(Main main ,UserVO uservo ,SaleReturnVO salereturnvo,ArrayList<SaleReturnVO> arrayList){
        mainList=arrayList;
        saleReturnVO=salereturnvo;
        ...
        /*
        tf_beforeSum.setText(""+salereturnvo.getTotalPrice());
        tf_discount.setText(""+salereturnvo.getDiscount());
        tf_substitute.setText(""+salereturnvo.getVoucher());
        */

        //tf_afterSum.setText(""+salereturnvo.getPayPrice());
        ...
        for(GoodsSaleReturnVO goodsSaleVO:set){
            SaleProcessDetail_XSLDJModel model = new SaleProcessDetail_XSLDJModel(goodsSaleVO.getVo().getNumber()+"",
                    goodsSaleVO.getVo().getName(),goodsSaleVO.getVo().getType(),""+goodsSaleVO.getSaleReturnNumber(),""+goodsSaleVO.getPrice()
                    ,goodsSaleVO.getSaleReturnNumber()*goodsSaleVO.getPrice()+"",goodsSaleVO.getRemark());
...
//        tf_beforeSum.setEditable(false);
    ...
    public void red() throws RemoteException{
        SaleReturnVO temp=helper.getSaleReturnBLService().addSaleReturnRed(saleReturnVO);
    ...
    public void redAndCopy() throws RemoteException{
        SaleReturnVO salereturnvo=helper.getSaleReturnBLService().addSaleReturnRed(saleReturnVO);
        AlertUtil.showInformationAlert("红冲成功！");
    ...
    public void out() throws Exception{
        ...
        ExcelTools.export("销售退货单"+date.getTime(),a);
    ...
    public void gotoSaleProcess(){
        main.gotoSaleProcessResult_XSTHD(userVO,mainList);
    }
