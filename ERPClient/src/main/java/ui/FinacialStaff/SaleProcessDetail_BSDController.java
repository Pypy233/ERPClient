...
public class SaleProcessDetail_BSDController implements Initializable{
    private Main main;
    private UserVO userVO;
    private LackListVO lackListVO;
    private ArrayList<LackListVO> mainList;
    ...
    public SaleProcessDetail_BSDController(){

    }//一个构造函数

    public void setMain(Main main,UserVO uservo,LackListVO lacklistvo,ArrayList<LackListVO> arrayList){
        this.main=main;
        this.userVO=uservo;
        this.lackListVO=lacklistvo;
        ...
        label_date.setText(lackListVO.getDate());
        tf_operator.setText("4");

        Set<GoodsLackVO> set = lackListVO.getSet();

        ObservableList<BYDModel> data = FXCollections.observableArrayList();

        for(GoodsLackVO vo:set){
    ...
    public void red() throws RemoteException{
        LackListVO temp = helper.getLackListBLService().addLackListRed(lackListVO);
    ...
    public void gotoSaleProcessResult(){
        main.gotoSaleProcessResult_BSD(userVO,mainList);
    }
    ...
    public void out() throws Exception{
        ...
        ExcelTools.export("报损单"+date.getTime(),a);
